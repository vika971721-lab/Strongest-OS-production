...
const rawEnvSchema = z.object({
  ...
  PLAN_3M_STARS: positiveIntegerFromEnv('399'),
  PLAN_3M_DAYS: positiveIntegerFromEnv('90'),
  PLAN_6M_STARS: positiveIntegerFromEnv('749'),
  PLAN_6M_DAYS: positiveIntegerFromEnv('180'),
  PLAN_12M_STARS: positiveIntegerFromEnv('1299'),
  PLAN_12M_DAYS: positiveIntegerFromEnv('365'),
...
export const parseEnv = (source: NodeJS.ProcessEnv): AppEnv => {
  ...
  const env: AppEnv = {
    ...
    pricing: {
      ...
      threeMonthsStars: parsed.data.PLAN_3M_STARS,
      threeMonthsDays: parsed.data.PLAN_3M_DAYS,
      sixMonthsStars: parsed.data.PLAN_6M_STARS,
      sixMonthsDays: parsed.data.PLAN_6M_DAYS,
      yearlyStars: parsed.data.PLAN_12M_STARS,
      yearlyDays: parsed.data.PLAN_12M_DAYS,
    },
