...
describe('stage 3 required scenario coverage', () => {
  ...
  it.each([
    ...
    ['banned', states.banned, 'Выбери режим доступа', 'Выбери срок продления', ''],
    ['deleted', states.deleted, 'Выбери режим доступа', 'Выбери срок продления', ''],
    ['broken', states.broken_link, 'Выбери режим доступа', 'Выбери срок продления', ''],
    [
      'database error',
      states.error,
      'Выбери режим доступа',
